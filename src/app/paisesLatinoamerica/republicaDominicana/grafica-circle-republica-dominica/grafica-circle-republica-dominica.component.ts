...
@Component({
  selector: 'app-grafica-circle-republica-dominica',
  templateUrl: './grafica-circle-republica-dominica.component.html',
  styleUrls: ['./grafica-circle-republica-dominica.component.css']
})
export class GraficaCircleRepublicaDominicaComponent implements OnInit {
...
public contadorIdiomas(): any {
  this.Tweets.forEach(idioma => {
    ...
    if (this.sentiment === 'positivo' && (this.locationUno === 'Santo Domingo' || this.locationUno === 'Santiago de los Caballeros' || this.locationUno === 'Puerto Plata' || this.locationUno === 'La Romana' || this.locationUno === 'Ciudad Colonial' || this.locationUno === 'Samaná' || this.locationUno === 'Concepción de la Vega' || this.locationUno === 'Higuey' || this.locationUno === 'Barahona' || this.locationUno === 'San Cristóbal')) {
      this.positivo++;
