...
@Component({
  selector: 'app-grafica-circle-argentina',
  templateUrl: './grafica-circle-argentina.component.html',
  styleUrls: ['./grafica-circle-argentina.component.css']
})
export class GraficaCircleArgentinaComponent implements OnInit {
// Pie
...
public contadorIdiomas(): any {
  this.Tweets.forEach(idioma => {
    ...
    if (this.sentiment === 'positivo' && (this.locationUno === 'Buenos Aires' || this.locationUno === 'Ciudad de Córdoba' || this.locationUno === 'Rosario' || this.locationUno === 'La Plata' || this.locationUno === 'Mendoza' || this.locationUno === 'San Miguel de Tucumán' || this.locationUno === 'Mar del plata' || this.locationUno === 'Paraná' || this.locationUno === 'Ushuaia' || this.locationUno === 'Salta')) {
      this.positivo++;
