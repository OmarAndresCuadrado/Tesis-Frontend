...
@Component({
  selector: 'app-grafica-circle-chile',
  templateUrl: './grafica-circle-chile.component.html',
  styleUrls: ['./grafica-circle-chile.component.css']
})
export class GraficaCircleChileComponent implements OnInit {
...
public contadorIdiomas(): any {
  this.Tweets.forEach(idioma => {
    ...
    if (this.sentiment === 'positivo' && (this.locationUno === 'Sabtuage de Chile' || this.locationUno === 'Concepción' || this.locationUno === 'La Serena' || this.locationUno === 'Valparaíso' || this.locationUno === 'Punta Arenas' || this.locationUno === 'Valdivia' || this.locationUno === 'Iquique' || this.locationUno === 'Arica' || this.locationUno === 'Viña del Mar' || this.locationUno === 'Puerto Montt')) {
      this.positivo++;
