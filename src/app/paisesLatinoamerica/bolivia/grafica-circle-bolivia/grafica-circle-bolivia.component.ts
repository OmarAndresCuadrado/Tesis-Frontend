...
@Component({
  selector: 'app-grafica-circle-bolivia',
  templateUrl: './grafica-circle-bolivia.component.html',
  styleUrls: ['./grafica-circle-bolivia.component.css']
})
export class GraficaCircleBoliviaComponent implements OnInit {
// Pie
...
public contadorIdiomas(): any {
  this.Tweets.forEach(idioma => {
    ...
    if (this.sentiment === 'positivo' && (this.locationUno === 'La Paz' || this.locationUno === 'Cochabamba' || this.locationUno === 'Santa Cruz de la Sierra' || this.locationUno === 'Sucre' || this.locationUno === 'Villa Imperial de Potosí' || this.locationUno === 'El Alto' || this.locationUno === 'Oruro' || this.locationUno === 'Tarija' || this.locationUno === 'Trinidad' || this.locationUno === 'Cobija')) {
      this.positivo++;
