...
@Component({
  selector: 'app-page-grafica-circle-guatemala',
  templateUrl: './page-grafica-circle-guatemala.component.html',
  styleUrls: ['./page-grafica-circle-guatemala.component.css']
})
export class PageGraficaCircleGuatemalaComponent implements OnInit {
...
public contadorIdiomas(): any {
  this.Tweets.forEach(idioma => {
    ...
    if (this.sentiment === 'positivo' && (this.locationUno === 'Ciudad de Guatemala' || this.locationUno === 'Antigua Guatemala' || this.locationUno === 'Petén' || this.locationUno === 'Alta Verapaz' || this.locationUno === 'Quché' || this.locationUno === 'Izabal' || this.locationUno === 'Esxuntla' || this.locationUno === 'Flores' || this.locationUno === 'Cobán' || this.locationUno === 'Escuintla')) {
      this.positivo++;
      // console.log('lenaguaje español' + 'valor contador', this.idiomaEspanol);
      // tslint:disable-next-line: max-line-length
    } else if (this.sentiment === 'negativo' && (this.locationUno === 'Ciudad de Guatemala' || this.locationUno === 'Antigua Guatemala' || this.locationUno === 'Petén' || this.locationUno === 'Alta Verapaz' || this.locationUno === 'Quché' || this.locationUno === 'Izabal' || this.locationUno === 'Esxuntla' || this.locationUno === 'Flores' || this.locationUno === 'Cobán' || this.locationUno === 'Escuintla')) {
